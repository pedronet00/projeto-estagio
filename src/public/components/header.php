...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar-template">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="/" id="home" style="font-family: Niramit; font-size: 22px;">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/src/public/views/blog" id="blog" style="font-family: Niramit; font-size: 22px;">Blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/src/public/views/departamentos" id="departamentos" style="font-family: Niramit; font-size: 22px;">Departamentos</a>
          </li>
        </ul>
