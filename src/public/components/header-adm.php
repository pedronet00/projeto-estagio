...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="/src/public/assets/favicon/logo.ico">
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="/"><img src="/src/public/assets/img/logo.webp" style="width: 80px; height: 80px;"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <?php if($_SESSION['nivelUsuario'] == 1 || $_SESSION['nivelUsuario'] == 2 || $_SESSION['nivelUsuario'] == 3){?>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/src/public/views/blog" target="_blank">Ver Blog</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="/src/public/views/adm/post/create.php">Criar Post</a></li>
            <li><a class="dropdown-item" href="/src/public/views/adm/tipo-post/create.php">Criar Tipo de Post</a></li>
            <li><a class="dropdown-item" href="/src/public/views/adm/post/read.php">Listar Posts</a></li>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if(isset($_SESSION['email'])){?>
          <li class="dropdown" style="list-style-type: none;">
            ...
            <ul class="dropdown-menu" style="list-style-type: none;">
              ...
              <li><hr class="dropdown-divider"></li>
              <li><p> <a href="/src/api/login/endsession.php">Sair</a></p></li>
            </ul>
        </li>
        <?php } else{ ?>
